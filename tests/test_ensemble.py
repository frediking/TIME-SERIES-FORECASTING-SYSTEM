...
class TestEnsemble:
    ...
    def ensemble(self):
        ...
        np.random.seed(42)
        return ForecastingEnsemble(random_state=42)

    def test_hyperparameter_loading(self, ensemble):
        params = {'xgboost': {'max_depth': 5}}
        ensemble.load_hyperparameters(params)
        assert ensemble.model_params['xgboost']['max_depth'] == 5
